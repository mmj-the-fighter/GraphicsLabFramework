...
#include <string.h>
#include <math.h>
#include "../grf/swr_sdl_window.h"
#include "../grf/swr_rasterizer.h"
#include "../grf/swr_image.h"
#include "../grf/swr_rfont.h"
...
int main(int argc, char **argv)
{
	...
	font = create_font("../res/glyphs.ppm", "../res/glyphs.csv");
	

	realimage = read_ppm_raw("../res/Lenaclor.ppm",LE, &realimagewidth, &realimageheight);
	realimage_clone = clone_image(realimage, realimagewidth, realimageheight, 4);

	birdimage = read_ppm_raw("../res/bird.ppm", LE, &birdimagewidth, &birdimageheight);
